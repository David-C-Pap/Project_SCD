...
public class PositionMapper {
    ...
    public Position dtoToPosition(PositionDTO positionDTO) {
        ...
        position.setTerminal(terminalRepository.findById(positionDTO.getTerminalId()).orElseThrow(() -> {var errMsg = "Terminalul cu Id '" + positionDTO.getTerminalId() + "nu exista";log.error(errMsg);
